...
def mapping(Text):
	...
	for Sent1 in Sents[1:]:
		...
		for Sent2 in Phrase[1:]:
			...
			for item in CandidateList[1:]:
				...
				MMTOut = [UttText,CandidateCUI, CandidateMatched, CandidatePreferred, SemType]
	...
	ModelTemplate = [UttText,ModelMap[UttText,'Theme'], ModelMap[UttText,'Theme_PCN'], ModelMap[UttText,'Theme_CUI'], ModelMap[UttText,'TOI_PCN'], ModelMap[UttText,'TOI_CUI'],ModelMap[UttText,'Event_PCN'],ModelMap[UttText,'Event_CUI'], ModelMap[UttText,'Linkage']]
	if ModelMap[UttText,'Theme']!='NA' and ModelMap[UttText,'Theme']!='' :
		print '\t'.join(ModelTemplate[0:])
	else:
		print UttText
